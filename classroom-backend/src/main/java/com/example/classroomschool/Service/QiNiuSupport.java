...
import com.example.classroomschool.Controller.File.QiNiuConfigBean;
...
//    }
     ...
     * @throws QiniuException
     */
    public String uploadFile(String homeworkId,String studentId,MultipartFile multipartFile) throws Exception {
...
//    }
     ...
     * @throws Exception
     */
    public File multipartFileToFile(String homeworkId,String studentId,MultipartFile file) throws Exception {
